...
func (g *Generator) Run(ctx context.Context, methods []openrpc.Method) error {
	...
	if err := os.Mkdir("proxy", 0o750); err != nil && !os.IsExist(err) {
		return err
	}

	paramsFile := jen.NewFile("proxy")
	paramsFile.HeaderComment("Code generated by /gen. DO NOT EDIT.")
	paramsDict := jen.Dict{}
	...
	g.log.Info("Generatetd proxy/params_gen.go file")
